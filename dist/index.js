...
var Component$2 = function Component(_ref) {
  ...
  var _useState = React.useState(numberToString(value)),
  ...
  return _extends({
    render: function render(_ref3) {
      var focus = _ref3.focus,
          rowData = _ref3.rowData,
          setRowData = _ref3.setRowData;
      return React.createElement(Component$2, {
...
var Component$3 = function Component(_ref) {
  ...
  var _useState = React.useState(numberToString$1(value * 100)),
      rawValue = _useState[0],
      setRawValue = _useState[1];
  ...
  return _extends({
    render: function render(_ref3) {
      var focus = _ref3.focus,
          rowData = _ref3.rowData,
          setRowData = _ref3.setRowData;
      return React.createElement(Component$3, {
        value: rowData[key],
        focus: focus,
        onChange: function onChange(value) {
          var _extends2;
...
var DataSheetGridContext = React.createContext({
  focus: false,
  activeCell: null,
  headerRowHeight: 0,
  rowHeight: 0,
...
var Row = React.memo(function (_ref) {
  ...
  var _useContext = React.useContext(DataSheetGridContext),
...
var useScrollbarWidth = function useScrollbarWidth() {
  ...
  React.useLayoutEffect(function () {
    setTimeout(function () {
      return setWidth(scrollbarWidth.scrollbarWidth());
    }, 0);
  }, []);
  return width;
};
...
var useColumnWidths = function useColumnWidths(width, columns, includeScrollbar) {
  ...
  var innerWidth = React.useMemo(function () {
...
var InnerContainer = React.forwardRef(function (_ref, ref) {
  ...
  var selectionIsDisabled = React.useMemo(function () {
    if (!selection) {
      return false;
    }
  ...
  })), children, activeCellRect && React.createElement("div", {
    className: cx({
  ...
  }), selectionRect && activeCellRect && React.createElement("div", {
    className: cx({
...
var throttledCompute = throttleDebounce.throttle(200, function (resultRef, ref, force) {
  if (force === void 0) {
    force = false;
  }
...
var useGetBoundingRect = function useGetBoundingRect(ref) {
  var boundingRect = React.useRef(null);
...
var AddRowsCounter = React.memo(function (_ref) {
  ...
  var _useState2 = React.useState(String(value)),
...
function DataSheetGrid(_ref4) {
  ...
  var containerRef = React.useRef(null);
  var outsideContainerRef = React.useRef(null);
  ...
  var scrollTo = React.useCallback(function (cell) {
  ...
  var getCursorIndex = React.useCallback(function (event, force) {
  ...
  var onDoneEditing = React.useCallback(function (_temp) {
  ...
  var onDuplicateRows = React.useCallback(function (rowMin, rowMax) {
    if (rowMax === void 0) {
      rowMax = rowMin;
    }
  ...
  var onDeleteRows = React.useCallback(function (rowMin, rowMax) {
    if (rowMax === void 0) {
      rowMax = rowMin;
    }
  ...
  var onCopy = React.useCallback(function (event) {
  ...
  var onCut = React.useCallback(function (event) {
    if (!editing && activeCell) {
      onCopy(event);
      onDelete();
      event.preventDefault();
  ...
  var onPaste = React.useCallback(function (event) {
    try {
  ...
  var counterAddRows = React.useCallback(function (batchSize) {
    if (batchSize === void 0) {
      batchSize = 1;
    }
  ...
  return React.createElement(DataSheetGridContext.Provider, {
    ...
    width: '100%',
    children: Row
  }), createRow && !lockRows && React.createElement(CounterComponent, {
    addRows: counterAddRows
  }), contextMenu && contextMenuItems.length > 0 && React.createElement(ContextMenuComponent, {
...
exports.DataSheetGrid = DataSheetGrid;
